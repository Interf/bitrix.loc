...
// Аналог $_SERVER['DOCUMENT_ROOT'] - пусть к текущему файлу
$documentRoot = Main\Application::getDocumentRoot();

if (empty($arParams['TEMPLATE_THEME']))
{
	// isModuleInstalled - установлен ли модуль
	...
	// Подключение каких-то тем из папки themes
...
$mobileColumns = array_fill_keys($mobileColumns, true);
 ...
 // возможно тут идет подключение шаблона
...
{ 
	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		...
		{
			?>
			<!-- Блок ввода купонов, итоговая цена и кнопка оформления заказа -->
			<div class="row">
