...
?><?$APPLICATION->IncludeComponent("bitrix:sale.order.ajax", "sale.order", Array(
	"ACTION_VARIABLE" => "soa-action",	// Название переменной, в которой передается действие
		...
		"ALLOW_APPEND_ORDER" => "N",	// Разрешить оформлять заказ на существующего пользователя
		...
		"PATH_TO_AUTH" => "",	// Путь к странице авторизации
		...
		"SPOT_LOCATION_BY_GEOIP" => "N",	// Определять местоположение покупателя по IP-адресу
